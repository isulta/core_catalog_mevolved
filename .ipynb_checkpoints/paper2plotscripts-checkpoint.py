def load_data(step):
    ...
    cc_HM = h5_read_dict('/home/isultan/projects/halomassloss/core_catalog_mevolved/output_ALCC_localhost_dtfactor_0.5_fitting/{}.corepropertiesextend.hdf5'.format(step), 'coredata')
...
def cores_plot(cc, centrals_mask, M1, M2, label, bins, r, A=0.9, zeta=0.001, mlim=0, returnMask=False): 
