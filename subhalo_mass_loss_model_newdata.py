...
cc_data_dir = '/home/isultan/data/AlphaQ/cooley_CoreCatalogs_rev4070/'
cc_output_dir = '/home/isultan/projects/halomassloss/core_catalog_mevolved/output_newdata_localhost_dtfactor_0.5_rev4070_v3/'
...
steps = sorted([int(i.split('.')[0]) for i in os.listdir(cc_data_dir) if '#' not in i])
step2z = {}
